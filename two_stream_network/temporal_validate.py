...
from two_stream_network.temporal_validate_model import Research_Model
from two_stream_network.temporal_validate_data import DataSet
import time
import os.path
...
def validate_temporal(saved_weights, class_limit):

    """These are the main training settings. Set each before running this file."""
    "=============================================================================="
    saved_weights = saved_weights # None or weights file
